                  ...
                  <tr key={r.id} className="border-t border-zinc-100">
                    <td className="px-2 py-2 text-center">
                      <button
                        ...
                        title="View bookings"
                      >
                        <span className="text-xs text-zinc-900">{expandedId === r.id ? "▾" : "▸"}</span>
                        <span>{r.full_name || "—"}</span>
                        <span className="text-xs text-zinc-900">View bookings</span>
                      </button>
                      <div className="text-xs text-zinc-900">{r.email}</div>
                    </td>
                    ...
                    <td className="px-2 py-2 text-center text-zinc-900">{formatDate(r.last_booking_start)}</td>
                    <td className="px-2 py-2 text-center">
                                  ...
                                  <tr key={b.id} className="border-t border-zinc-100 text-zinc-900">
                                    <td className="py-2 text-center">
                                      <a
                                        ...
                                        className="rounded-full bg-black px-2 py-1 text-[10px] font-semibold text-white hover:bg-zinc-900"
                                      >
                                        View
                                      </a>
                                    </td>
